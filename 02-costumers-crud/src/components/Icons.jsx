//Ícones utilizados em Table.jsx e Modal.jsx
...
export function EditIcon() {
    return (
        <svg
            ...
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            className="w-6 h-6 stroke-green-600 stroke-2"
        >
            <path
                strokeLinecap="round"
...
export function DeleteIcon() {
    return (
        <svg
            ...
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            className="w-6 h-6 stroke-red-600 stroke-2"
        >
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
...
export function WarningIcon(props) {
    return (
        <svg
            ...
            viewBox="0 0 24 24"
            strokeWidth={1}
            className={`w-16 h-16 stroke-red-500 ${props.className}`}
        >
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
